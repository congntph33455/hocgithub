...
<body>
    <div class="menu-container">
        <div class="left-menu">
            <div class="menu-logo"><a href="index.php"></a>
            ...
            <div class="intro"><a href="#">GoMovie<br>Let's go</a></div>
        </div>
        <nav class="menu-nav">
            <ul>
                <li><a href="index.php?act=lichchieu">Lịch chiếu</a></li>
                <li><a href="index.php?act=phimchieu">Phim chiếu</a></li>
                <li class="dropdown">
                    <a href="index.php?act=dstk">Tài khoản</a>
                    <ul class="submenu">
                        <li><a href="index.php?act=dsbl">Comment</a></li>
                        <li><a href="index.php?act=thongketk">Thống Kê</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="./Account/account.html">Quản lý phim</a>
                    <ul class="submenu">
                        <li><a href="index.php?act=addtheloai">Thể loại</a></li>
                        <li><a href="index.php?act=addphim">Danh sách phim</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="">Thông kê</a>
                    <ul class="submenu">
                        <li><a href="index.php?act=thongkebl">Comment</a></li>
                        <li><a href="index.php?act=thongketk">Tài khoản</a></li>
                    </ul>
                </li>
                <li class="logo-icon">
